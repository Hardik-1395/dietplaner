...
def main():
    ...
    # Main content area
    if generate_button:
        st.markdown('<h2 class="sub-header">🎯 Generating Your Personalized Meal Plan</h2>', unsafe_allow_html=True)
        ...
        with st.spinner("Analyzing your requirements and generating meal plan..."):
            try:
                ...
                # Display results
                st.markdown('<h3 class="sub-header">📋 Your Personalized Meal Plan</h3>', unsafe_allow_html=True)
